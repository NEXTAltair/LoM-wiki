...
<td>結緣後の任意の時点</td>
<td>下山して繁華街を巡る</td>
<td>唐默鈴との同行イベント「道を教える」が追加される。</td>
<td>心相+30</td>
</tr>
...
<td>断った場合の結果が、唐默鈴と一緒に修練する内容に変わる。</td>
<td>武学+3、心相+5</td>
</tr>
...
<td>3年目9月上旬
    <br>から4年目10月上旬まで</td>
<td>錦香宮への道中及び滞在</td>
<td>• 道中イベント: 戦役で唐默鈴を参加させられる、各所で展開が変化する。
    <br>• 錦香宮: 各所で展開が変化する。
...
<td>• 女弟子房の展開が分岐する。
    <br>• <MarkdownWrapper>[汗青書25：江湖引退](/ja/event/ends/end-25)</MarkdownWrapper>の結末演出が唐默鈴と共に過ごすバージョンになる。</td>
<td></td>
</tr>
...
<td>小師妹に付き添う</td>
<td>女弟子房に行くと唐默鈴の髪を梳くイベントが発生する。</td>
<td>このイベントを発生させない場合、残り行動回数2の時点で唐默鈴が待ちぼうけを食らうイベントが自動発生する。</td>
</tr>
