...
const STALE_TERMS = [
	...
	{ bad: "結識", good: "面識を得る", note: "中国語。イベント表の分岐ラベル・結果ラベルに残っていた。ページ名の『初識〜』は別語で対象外 (2026-08-02)" },
	...
	{ bad: "比試", good: "試合/手合わせ(文脈で判断)", note: "中国語。武術の試合・私的な立ち合いいずれも比試と書くが、日本語にない語。19箇所を一掃 (2026-08-24)" },
	{ bad: "入坑", good: "ハマる/遊び始める(文脈で判断)", note: "中国語ネットスラング (作品にハマること)。日本語にない語。10箇所を一掃 (2026-08-24)" },
];
